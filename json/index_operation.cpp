...
void insert_json(cJSON *item){
    ...
    insertIndex->tbname= cJSON_Print(cJSON_GetObjectItem(item, "name"));
    printf("tbname:%s\n",insertIndex->tbname);
...
//    strcat(insertIndex->tbname,(insertIndex->tag)->tag_values);
    ...
    ((indexBlock->indexMeta)->Key)=index_strcat(insertIndex->tbname,(insertIndex->tag)->tag_name);
    printf("key:%s\n",(indexBlock->indexMeta)->Key);
//    strcat((indexBlock->indexMeta)->Key,insertIndex->tbname);
//    strcat((indexBlock->indexMeta)->Key,(insertIndex->tag)->tag_values);
